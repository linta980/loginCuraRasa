  ...
  <div id="container">
    ...
    <div class="jumbotron">
      <fieldset id="field">
        ...
        <div>
          <v-alert v-model="alert" dismissible type="success">Uspesno ste promenili sliku</v-alert>
        </div>
        ...
        <div class="form-group">
          <div class="input-group mb-3">
            <form enctype="multipart/form-data" @submit.prevent="poslji_sliku">
              ...
              <!-- <div v-if="file_selected" style="margin:20px 30%;">
                <v-btn color="warning">Upload</v-btn>
              </div> -->
    ...
    <div id="app">
      <v-app id="inspire">
        <v-footer class="pa-3">
          <v-spacer></v-spacer>
          <div>PowerdBy RCG team &copy; {{ new Date().getFullYear() }}</div>
        </v-footer>
      </v-app>
    </div>
  </div>
